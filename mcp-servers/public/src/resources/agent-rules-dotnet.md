...
If the current project does not have a `CLAUDE.md` or `AGENTS.md` file, or if the directive doesn't exist in the file(s), suggest creating one and include the following instruction in it:
